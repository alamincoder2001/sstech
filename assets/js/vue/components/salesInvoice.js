  ...
  template: `
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>Company Id:</strong> {{ sales.Customer_Code }}<br>
                        <strong>Company Name:</strong> {{ sales.owner_name }}<br>
                        <strong>Customer Name:</strong> {{ sales.Customer_Name }}<br>
                        <strong>Company Address:</strong> {{ sales.Customer_Address }}<br>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right"> {{ parseFloat(Number(sales.SaleMaster_cashPaid) + Number(sales.SaleMaster_bankPaid)).toFixed(2)  }} </td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>

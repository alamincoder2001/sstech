        ...
        try {
            ...
            foreach ($data->cartProducts as $product) {
                if ($product->productId == 'P01') {
                    ...
                    $product['Product_Purchase_Rate'] = $product->purchaseRate;
                    $product['Product_SellingPrice']  = $product->salesRate;
                    $product['ProductCategory_ID']    = 1;
                    $product['Unit_ID']               = 1;
                    $product['is_service']            = 'false';
                    $product['status']                = 'a';
                ...
                $prodId = $cartProduct->productId == 'P01' ? $Product_Id : $product->productId;

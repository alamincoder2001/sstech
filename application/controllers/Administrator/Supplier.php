    ...
    public function getSupplierLedger()
    {
        ...
        $payments = $this->db->query("
            ...
            select
                ...
                concat('Paid to supplier', ' ', sp.SPayment_notes) as description,
                0.00 as bill,
                sum(sp.SPayment_amount_cash + sp.SPayment_amount_bank) as paid,
                0.00 as due,
                0.00 as returned,
                0.00 as cash_received,
                0.00 as balance
            ...
            select 
                ...
                concat('Received from Supplier', ' ', sp2.SPayment_notes) as description,
                0.00 as bill,
                0.00 as paid,
                0.00 as due,
                0.00 as returned,
                sum(sp2.SPayment_amount_cash + sp2.SPayment_amount_bank) as cash_received,
                0.00 as balance

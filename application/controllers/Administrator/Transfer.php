        ...
        public function addProductTransfer(){
            ...
            try{
                ...
                foreach($data->cart as $cartProduct){
                    ...
                    $currentBranchInventoryCount = $this->db->query("select * from tbl_currentinventory where product_id = ? and size_id = ? and color_id = ? and branch_id = ?", [$cartProduct->product_id, $cartProduct->size_id, $cartProduct->color_id, $this->session->userdata('BRANCHid')])->num_rows();
                    if($currentBranchInventoryCount == 0){
                        ...
                        $this->db->query("
                            ...
                            and color_id = ? 
                            and branch_id = ?
                        ", [$cartProduct->quantity, $cartProduct->product_id, $cartProduct->size_id, $cartProduct->color_id, $this->session->userdata('BRANCHid')]);
                    }

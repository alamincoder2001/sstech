...
$paid_cash = $CPROW->CPayment_amount_cash;
$paid_bank = $CPROW->CPayment_amount_bank;
...
$totalDue = $type == 'CR' ? $prevdueAmont - ($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank) : $prevdueAmont + ($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank);
...
<div class="content_scroll" style="width: 850px; ">
    ...
    <div id="reportContent">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <?php if ($type == 'CR') : echo number_format(($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank), 2);
                                else : echo '00.00';
                                endif; ?></td>
                            <td style="text-align:right;">
                                <?php if ($type == 'CP') : echo number_format(($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank), 2);
                                else : echo '00.00';
                                endif; ?></td>
                        </tr>
                        <tr>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <h6 style=" font-size: 12px; font-weight: 600;">Paid (In Word): <?php echo convertNumberToWord($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank); ?></h6>
            </div>
        </div>
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; text-align: right; "><?php echo number_format($CPROW->CPayment_amount_cash + $CPROW->CPayment_amount_bank, 2); ?></td>
                    </tr>
                    <tr>
